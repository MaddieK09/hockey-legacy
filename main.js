...
function create() {
    ...
    scene.gameState = {
        ...
        playerMaximumSpeed: 155,
        playerAcceleration: 700,
        playerDeceleration: 850,
...
function handlePlayerPuckCollision(scene) {
    ...
    state.puckVelocityX +=
        normalX * 25 +
        state.playerVelocityX * 0.18;

    state.puckVelocityY +=
        normalY * 25 +
        state.playerVelocityY * 0.18;
}
